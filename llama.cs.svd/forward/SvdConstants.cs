...
public static class SvdConstants
{
    ...
    public static class RankRatios
    {
        ...
        public const float WQ = 0.7f; // 20% of min dimension
        public const float WK = 0.7f;
        public const float WV = 0.7f;

        // Output projection (can often use lower rank)
        public const float WO = 0.7f;

        // Feed-forward networks (typically benefit most from SVD)
        public const float W1 = 0.7f; // Often has redundancy
        public const float W2 = 0.7f;
        public const float W3 = 0.7f;
    }
